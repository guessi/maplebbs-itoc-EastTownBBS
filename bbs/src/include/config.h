...
#define SCHOOLNAME	"東華大學"		/* 組織名稱 */
#define BBSNAME		"東方小城"		/* 中文站名 */
#define BBSNAME2	"EastTown"		/* 英文站名 */
#define SYSOPNICK	"SYSOP"			/* sysop 的暱稱 */
#define TAG_VALID       "[EastTown]To"		/* 身分認證函 token */

#define MYIPADDR	"134.208.10.240"	/* IP address */
#define MYHOSTNAME	"bbs.ndhu.edu.tw"	/* 網路地址 FQDN */

#define HOST_ALIASES	{MYHOSTNAME, MYIPADDR, \
			 "EastTown.twbbs.org", "EastTown.twbbs.org.tw", \
			 NULL}
...
#undef	JUSTIFY_PERIODICAL	/* 定期身分認證 */
...
#undef	HAVE_CHANGE_ID		/* 使用者名單 ^D 暫時更改 ID */

#define HAVE_CHANGE_FEEL	/* 使用者名單 M 永久更改心情 */

#undef	HAVE_WHERE		/* itoc.001102: 使用者名單故鄉辨識，參照 etc/host fqdn */
...
#undef	HAVE_SUPERCLOAK		/* itoc.020602: 紫隱，站長超級隱形 */

  /* ------------------------------------------------- */
  /* 組態規劃˙看板信箱                                */
  /* ------------------------------------------------- */
      
#undef	HAVE_ANONYMOUS		/* 提供 anonymous 板 */
...
#define MAXGUEST        100             /* 最多參觀者  */
#define MAXIPLOGIN      10              /* 最多相同來源IP登入 */
#define MAXIPLOGINGUEST 5               /* 最多相同來源IP GUEST登入 */
...
#define	MAX_BBSMAIL	9999		/* PERM_MBOX 收信上限(封) */
#define	MAX_VALIDMAIL	999		/* 認證 user 收信上限(封) */
#define	MAX_NOVALIDMAIL	99		/* 未認證 user 收信上限(封) */
...
#ifdef HAVE_COSIGN
#define NBRD_NUM_BRD	30		/* 開板需要連署人數 */
#define NBRD_DAY_BRD	7		/* 開板可連署天數 */
#endif

/* post.c 偵測 cross-post */

#ifdef  HAVE_DETECT_CROSSPOST
#define	MAX_CROSS_POST		5	/* cross post 最大數量(篇) */
