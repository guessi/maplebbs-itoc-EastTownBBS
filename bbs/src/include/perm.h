...
#define PERM_ADMIN3	0x04000000	/* no use */
...
#define PERM_GUARANTOR	PERM_VALID
  ...
  站長 PERM_SYSOP ┼ 聊天室總管 PERM_CHATROOM : 在聊天室是 roomop。
                  │
                  ├ 看板總管 PERM_BOARD : 可以修改看板設定、進入秘密及好友\看板。
                  │
...
#define PERM_ALLADMIN	(PERM_REGISTRAR | PERM_BOARD | PERM_CHATROOM | PERM_ACCOUNTS | PERM_SYSOP)	/* 站務 */
...
#define STR_PERM	"bctpjm#xf------@PTCM--L*BN-RACBS"
