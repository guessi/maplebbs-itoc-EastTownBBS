  ...
  userec *old;
{
  ...
  str_ncpy(new.feeling, "    ", sizeof(new.feeling)); /* 新增心情欄位 060319 guessi */
  new.staytime = 0;  /* 掛站時數統計 060319 guessi */
  ...
  userec *old;
{
  ...
  for (i = 1; i <= 6; i++)	/* Maple 3.0 只有三個簽名 */ /* 改為六個 guessi */
  {
